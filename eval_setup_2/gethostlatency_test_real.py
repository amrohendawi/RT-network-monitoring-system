...
hosts = ['192.168.178.1', '192.168.178.74', '192.168.178.91', '192.168.178.92', '192.168.178.90', '192.168.178.84', '192.168.178.86', '192.168.178.81']
# hosts = [str.encode(str(ip + i)) for i in range(0,args.nodes)] 
