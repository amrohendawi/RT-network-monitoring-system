#!/usr/bin/python
#
# This is a modified version of gethostlatency: Show latency for getaddrinfo/gethostbyname[2] calls.
...
targetHost = str.encode(args.host)
